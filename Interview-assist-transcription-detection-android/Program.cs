using Interview_assist_audio_android;
...
namespace InterviewAssist.TranscriptionDetectionAndroid;
...
public class TranscriptionApp
{
    ...
    private async Task StartTranscriptionAsync(CancellationToken ct)
    {
        try
        {
            ...
            var audio = new AndroidAudioCaptureService(_sampleRate, _audioSource);
